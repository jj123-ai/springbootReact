    ...
    <div className="border-2 border-sky-200 mt-10 m-2 p-4">
      ...
      <div className="flex justify-center">
        <div className="relative mb-4 flex w-full flex-wrap items-stretch">
          <div className="w-1/5 p-6 text-rigth font-bold">제품명</div>
          <input
            type="text"
            name="pname"
            value={product.pname}
      ...
      <div className="flex justify-center">
        <div className="relative mb-4 flex w-full flex-wrap items-stretch">
          <div className="w-1/5 p-6 text-rigth font-bold">상세 설명</div>
          <input
            type="text"
            name="pdest"
            value={product.pdesc}
      ...
      <div className="flex justify-center">
        <div className="relative mb-4 flex w-full flex-wrap items-stretch">
          <div className="w-1/5 p-6 text-rigth font-bold">가격</div>
          <input
            type="text"
            name="price"
            value={product.price}
      ...
      <div className="flex justify-center">
        <div className="relative mb-4 flex w-full flex-wrap items-stretch">
          <div className="w-1/5 p-6 text-rigth font-bold">삭제</div>
          <select
            name="delFlag"
      ...
      <div className="w-full justify-center flex felx-col m-auto items-center">
        <div className="relative mb-4 flex w-full flex-wrap items-stretch">
